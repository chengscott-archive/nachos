...
#define MaxFileSize 	(NumDirect * NumDirect * NumDirect * NumDirect * SectorSize)
#define SingleSize (NumDirect * SectorSize)
#define DoubleSize (NumDirect * NumDirect * SectorSize)
#define TripleSize (NumDirect * NumDirect * NumDirect * SectorSize)
